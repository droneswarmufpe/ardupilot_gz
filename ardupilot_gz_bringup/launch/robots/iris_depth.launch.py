...
def launch_state_pub_with_bridge(context):
    ...
    sdf_file = os.path.join(
        pkg_ardupilot_gz_description, "models", "iris_depth", "model.sdf"
    )

    with open(sdf_file, "r") as infp:
        robot_desc = infp.read()

    ros_gz_bridge_config = "iris_depth.yaml"

    log = LogInfo(msg="Using iris_depth model and iris_depth.yaml")
